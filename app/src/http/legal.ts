...
export function privacyPage(): string {
  return renderLegalPage(
    ...
    `<h1>Integritetspolicy</h1>
     ...
     <p>Om något går fel i appen kan enheten skicka ett kort felmeddelande och vilken skärm du var på, så att vi kan felsöka. Meddelandet ska inte innehålla lösenord eller inloggningstoken. Vi använder det inte för marknadsföring.</p>
