...
Canonical produkt- och databasgrund. Vertical slice + publik landning med intresseanmälan på `https://korpasset.se`. Produktappen har elev- och handledarhem, live-anteckningar, läge i procent från bedömningar, hjälp/feedback och gästfallback. Produktkonton: Sign in with Apple och Google i appen (`/app`, ADR-008). Store-publicering: [native-apps.md](docs/operations/native-apps.md).
